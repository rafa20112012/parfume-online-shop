	...
	<body>
		<table cellpadding="0" cellspacing="0" border="0" width="100%" height="100%">
			<tr style="height: 50px; width: 100%;">
				<td colspan="2" style="font-weight: bold; text-align: center; height: 50px; width: 100%; font-family: Tahoma, Verdana, Arial; font-size: 10pt;">Administration section :: Add manufacturer</td>
			</tr>
			<tr>
				...
				<td style="width: 700px;" valign="top" align="center">
					<form name="frmAdaugaProducator" id="frmAdaugaProducator" method="post" action="execute.php?action=adaugareproducator" onSubmit="return fValidareAdaugareProducator();">
						<table cellpadding="5" cellspacing="0" border="0" width="700" class="modelspecs">
							<tr>
								<td align="center" colspan="2" style="font-family: Tahoma, Verdana, Arial; font-weight: bold; font-size: 11pt;"><br>Add manufacturer<br><br></td>
							</tr>
							<tr bgcolor="#C1C1FF">
							...
							<tr bgcolor="#C1C1FF">
								...
								<td width="450"><input type="text" value="http://" name="txtURL" id="txtURL" class="text" maxlength="255" style="width: 300px;"></td>
							</tr>
							<tr bgcolor="#C1C1FF">
								<td align="right" width="250">Description:</td>
								<td width="450"><textarea name="txtDescriere" id="txtDescriere" class="text" style="width: 300px; height: 150px;"></textarea></td>
							</tr>
							<tr bgcolor="#C1C1FF">
